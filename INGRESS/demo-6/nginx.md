```bash
controlplane:~$ kubectl exec -it -n ingress-nginx ingress-nginx-controller-74fdcbccdc-ps967 -- cat /etc/nginx/nginx.conf

# Configuration checksum: 1659101353740427879
...
http {
        ...
        # PEM sha: 305cb7cd168f0e0403eb4c43248768cf7e235db0
        ...
        server {
                ...
                location "/" {
                        ...
                        set $namespace      "myapp-ns";
                        set $ingress_name   "myapp-ingress";
                        set $service_name   "myapp-service";
                        set $service_port   "80";
                        set $location_path  "/";
                        ...
                        set $balancer_ewma_score -1;
                        set $proxy_upstream_name "myapp-ns-myapp-service-80";
                        set $proxy_host          $proxy_upstream_name;
                        set $pass_access_scheme  $scheme;

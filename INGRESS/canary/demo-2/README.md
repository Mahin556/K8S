...
while sleep 0.5;do curl -H "Host: canary-app.com" http://localhost:8080/; echo; done # VERSION 1
while sleep 0.5;do curl -H "Host: canary-app.com" -H "X-Canary: always" http://localhost:8080/; echo; done # VERSION 2
```
...
It is one of the example you can imaging multiple architecture like this.
...
* The database(RDS instance, stateful sets) is costly that's why they are shared by many application, only critical applications can have saperate databases.
...
* You can also create your own topology labels or any custome labels to control scheduling.
* We can use topologySpreadConstraint in case of deployment to spread 10 pods on 3-4 nodes.
